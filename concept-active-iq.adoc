...
Modification pour la localisation. Activer l'affichage docbot et test loc. Test de la désactivation du docbot. Tester la mise à niveau de ruby sur la branche d'activation.
