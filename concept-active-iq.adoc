...
Modification pour la localisation. Activer l'affichage docbot et test loc. Test de la désactivation du docbot. Re-test de la mise à niveau ruby pour une troisième fois. Test voir tous les résultats de la traduction de l'étiquette.
