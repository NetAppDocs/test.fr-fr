...
[role="lead"]
L'enregistrement du support est requis pour votre compte BlueXP et pour chaque système Cloud Volumes ONTAP.
...
Pour obtenir un support technique sur les solutions des fournisseurs cloud suivants, consultez la section « obtention d'aide » dans la documentation BlueXP pour ce produit.
