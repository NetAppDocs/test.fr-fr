...
Modification pour la localisation. Activer l'affichage docbot et test loc. Test de la désactivation du docbot. Test ruby mise à niveau avec l'action gh rajoutée.
